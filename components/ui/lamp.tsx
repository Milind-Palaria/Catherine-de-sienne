...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950/0 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1  scale-y-[3.25] items-center justify-center isolate z-0 ">
        <motion.div
